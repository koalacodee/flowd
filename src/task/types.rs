...
use crate::task::group::RunnableQueue;
...
///
/// Construct with [`QueueGroup::from_queues`], add queues with
/// [`QueueGroup::push`], then call [`QueueGroup::run_all`] to start them
/// all and obtain a [`QueueGroupHandle`] for coordinated shutdown.
///
/// # Example
///
/// ```rust,ignore
